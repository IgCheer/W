    ...
    (() => {
        ...
        class Popup {
            ...
            _openToHash() {
                ...
                const buttons = classInHash ? document.querySelector(`[${this.options.attributeOpenButton}="${classInHash}"]`) || document.querySelector(`[${this.options.attributeOpenButton}="${classInHash.replace(".", "#")}"]`) : null;
            ...
            _focusTrap() {
                const previousOpenElement = this.previousOpen.element;
                if (previousOpenElement) {
                    const focusable = previousOpenElement.querySelectorAll(this._focusEl);
        ...
        function initSliders() {
            if (document.querySelector(".body-design__slider")) new swiper_core_Swiper(".body-design__slider", {
                ...
                parallax: true,
                pagination: {
                    el: ".slider-design__bottom .controls__fractions",
                    clickable: true,
                    type: "fraction",
                ...
                navigation: {
                    prevEl: ".design__body .controls-button-prev",
                    nextEl: ".design__body .controls-button-next"
                }
            });
            if (document.querySelector(".body-team__slider")) new swiper_core_Swiper(".body-team__slider", {
                ...
                navigation: {
                    prevEl: ".team__body .controls-button-prev",
                    nextEl: ".team__body .controls-button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1.2,
            ...
            function updateVisibleSlides(swiper) {
                ...
                var visibleSlides = Math.floor(containerWidth / (containerWidth / slidesPerView));
                for (var i = 0; i < swiper.slides.length; i++) swiper.slides[i].classList.remove("swiper-slide-visible");
                for (i = 0; i < visibleSlides; i++) swiper.slides[swiper.activeIndex + i]?.classList.add("swiper-slide-visible");
            }
            if (document.querySelector(".body-reviews__slider")) new swiper_core_Swiper(".body-reviews__slider", {
                ...
                loop: true,
                pagination: {
                    el: ".reviews__body .swiper-pagination",
                    clickable: true,
                    renderBullet: function(index, className) {
                        return `<div data-slide="${index}" class="${className}"><span>${index < 10 ? "0" + (index + 1) : index + 1}</span><span>${index < 10 ? "0" + (index + 1) : index + 1}</span></div>`;
                    }
                ...
                navigation: {
                    prevEl: ".reviews__body .controls-button-prev",
                    nextEl: ".reviews__body .controls-button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1.2,
            ...
            if (document.querySelector(".body-news__slider-all")) new swiper_core_Swiper(".body-news__slider-all", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 3.5,
                ...
                watchSlidesProgress: true,
                pagination: {
                    el: ".body-news-tabs_all .swiper-pagination",
                    clickable: true,
                    renderBullet: function(index, className) {
                        return `<div data-slide="${index}" class="${className}"><span>${index < 10 ? "0" + (index + 1) : index + 1}</span><span>${index < 10 ? "0" + (index + 1) : index + 1}</span></div>`;
                    }
                ...
                navigation: {
                    prevEl: ".body-news-tabs_all .controls-button-prev",
                    nextEl: ".body-news-tabs_all .controls-button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1.2,
            ...
            if (document.querySelector(".body-news__slider-news")) new swiper_core_Swiper(".body-news__slider-news", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 3.5,
                ...
                watchSlidesProgress: true,
                pagination: {
                    el: ".body-news-tabs_news .swiper-pagination",
                    clickable: true,
                    renderBullet: function(index, className) {
                        return `<div data-slide="${index}" class="${className}"><span>${index < 10 ? "0" + (index + 1) : index + 1}</span><span>${index < 10 ? "0" + (index + 1) : index + 1}</span></div>`;
                    }
                ...
                navigation: {
                    prevEl: ".body-news-tabs_news .controls-button-prev",
                    nextEl: ".body-news-tabs_news .controls-button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1.2,
            ...
            if (document.querySelector(".body-news__slider-reviews")) new swiper_core_Swiper(".body-news__slider-reviews", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 3.5,
                ...
                watchSlidesProgress: true,
                pagination: {
                    el: ".body-news-tabs_reviews .swiper-pagination",
                    clickable: true,
                    renderBullet: function(index, className) {
                        return `<div data-slide="${index}" class="${className}"><span>${index < 10 ? "0" + (index + 1) : index + 1}</span><span>${index < 10 ? "0" + (index + 1) : index + 1}</span></div>`;
                    }
                ...
                navigation: {
                    prevEl: ".body-news-tabs_reviews .controls-button-prev",
                    nextEl: ".body-news-tabs_reviews .controls-button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1.2,
            ...
            if (document.querySelector(".body-news__slider-recomm")) new swiper_core_Swiper(".body-news__slider-recomm", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 3.5,
                ...
                watchSlidesProgress: true,
                pagination: {
                    el: ".body-news-tabs_recomm .swiper-pagination",
                    clickable: true,
                    renderBullet: function(index, className) {
                        return `<div data-slide="${index}" class="${className}"><span>${index < 10 ? "0" + (index + 1) : index + 1}</span><span>${index < 10 ? "0" + (index + 1) : index + 1}</span></div>`;
                    }
                ...
                navigation: {
                    prevEl: ".body-news-tabs_recomm .controls-button-prev",
                    nextEl: ".body-news-tabs_recomm .controls-button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1.2,
            ...
            if (document.querySelector(".body-documents__slider")) new swiper_core_Swiper(".body-documents__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 2.6,
                ...
                speed: 1200,
                pagination: {
                    el: ".slider-documents__bottom .documents-fractions",
                    clickable: true,
                    type: "fraction",
                    formatFractionCurrent: function(number) {
                        return ("0" + number).slice(-2);
                ...
                navigation: {
                    prevEl: ".documents__body .controls-button-prev",
                    nextEl: ".documents__body .controls-button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1.3,
...
***************************************************************************** */
        ...
        window.onload = function() {
            var draggableBlocks = document.querySelectorAll(".draggable-block");
            if (draggableBlocks.length > 0) draggableBlocks.forEach((function(draggableBlock) {
                var gallery = draggableBlock.querySelector(".draggable-block__gallery");
                if (window.matchMedia("(min-width: 991.98px)").matches) Draggable.create(".gallery-draggable-block__wrapper", {
                    bounds: draggableBlock,
                    inertia: true,
                    onDragStart: function() {
                        gallery.classList.add("_draggable");
                    },
                    onDragEnd: function() {
                        gallery.classList.remove("_draggable");
                    }
                });
            }));
        };
